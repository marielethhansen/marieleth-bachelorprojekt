...
***********************************Gennemsnit til figur over evaluering af lederkompetencer***********************************
...
***********************************Robusthedstjek/trevejsinteraktioner***********************************
/*Robusthedstjek 1: frasortering af de respondenter i treatmentgruppen, som ikke blev påvirket af treatment og dermed ikke tænkte på terrortrussel under surveyeksperimentet*/
...
/*Robusthedstjek 2: Trevejs-interaktion med respondentens køn. Omkodning af køn med missing values*/
...
/*Robusthedstjek 3: Trevejs-interaktion med respondentens ideologi. Ideologi kodet i blokke.*/
...
/*Robusthedstjek 4: Trevejsinteraktioner - hvorvidt respondenterne tænkte på Corona-virus under deres vurdering af politikerne. De respondenter, der tænkte på Corona-virus under survey-eksperimentet kan have mudret billedet*/
***Sletning af observationer som tænkte på Corona-virus under ekserimentet***
egen tanker=rowmean(tankervurderingsøren tankervurderingsusanne)
drop if tanker ==3
reg Kompetence2 i.politikerkøn##i.kontekst,r

***Lave en dummy-variabel af dem der tænkte på Corona-virus***
...
/*Robusthedstjek 4: Trevejsinteraktioner - Sammenhængen undersøges for de respondenter som generelt har stereotyper på sikkerhedsområdet*/
...
***Undersøgelse af om sammenhængen stadig er signfikant hvis "Ingen forskel" bliver reference-kategori***
...
/*Udregning af gennemsnit og herefter chi-i-anden-test af baggrundsvariablene: ideologi, alder, køn, uddannelsesniveau, geografi*/
recode højrevenstreplacering (89/.=.)
...
***********************************Manipulationstjek***********************************
/*Undersøgelse af om manipulation af den uafhængige variabel har virket efter hensigten. Udregning af femininitets og maskulinitetsvurdering for de fire grupper - feminin/maskulin samkodet og herefter tjek*/
egen femimask=rowmean(femimasksøren femimasksusanne)
mean femimask, over (politikerkøn)
ttest femimask, by (politikerkøn)

/*Undersøgelse af om manipulationen af terrortrussel har ført til den tilsigtede forskel i hvorvidt respondenterne tænkte på en terrortrussel ved vurderingen af politikerne*/
egen tankervurdering=rowmean(tankervurderingsøren tankervurderingsusanne)
tab tankervurdering
